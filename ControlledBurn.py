...
POPULATION_CLASSES = 7 # This is modified to create different state numbers.
# The number of years since a fire classes
FIRE_CLASSES = 13 # This is modified to create different state numbers.
# The number of states is the product of Population Classes & Fire Classes
STATES = POPULATION_CLASSES * FIRE_CLASSES
# The number of actions which equals two. Burn or Do Nothing.
ACTIONS = 2
ACTION_NOTHING = 0
ACTION_BURN = 1
